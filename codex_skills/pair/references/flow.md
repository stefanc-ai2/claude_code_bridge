...
- Prefer background mode if your environment defaults to foreground and you want to keep working.
- If a provider is mounted but slow to respond, continue with other work and revisit with `pend`.
